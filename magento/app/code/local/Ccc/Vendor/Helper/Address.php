...
class Ccc_Vendor_Helper_Address extends Mage_Core_Helper_Abstract
{
    ...
    public function getConfig($key, $store = null)
    {
        ...
        if (!isset($this->_config[$websiteId])) {
            $this->_config[$websiteId] = Mage::getStoreConfig('vendor/address', $store);
        }
    ...
    public function getStreetLines($store = null)
    {
        ...
        if (!isset($this->_streetLines[$websiteId])) {
            $attribute = Mage::getSingleton('eav/config')->getAttribute('vendor_address', 'street');
    ...
    {
        $format = Mage::getSingleton('vendor/address_config')->getFormatByCode($code);
