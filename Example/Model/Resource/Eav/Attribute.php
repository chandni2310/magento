...
class Ccc_Example_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const SCOPE_STORE                           = 0;
    ...
    const ENTITY                                = 'example_eav_attribute';
    ...
    public static function initLabels($storeId = null)
    {
        if (is_null(self::$_labels)) {
            ...
            $attributes = Mage::getResourceSingleton('exampleattribute/exampleattribute')->getAttributesByCode();
